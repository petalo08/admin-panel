  ...
  return (
    <div>
       <Disclosure as="nav">
        ...
        <div className="p-6 w-1/2 h-screen bg-lime-200 z-20 fixed top-0 -left-96 lg:w-60 lg:left-0 peer-focus:left-0 peer:transition ease-out delay-150 duration-200 ">
